...
export { SoftSkillsSection as SoftSkills } from "./soft-skills";
export { DigitalSkillsSection as DigitalSkills } from "./digital-skills";
export { ConferencesSection as Conferences } from "./conferences";
